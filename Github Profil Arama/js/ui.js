class UI {
    constructor() {
        ...
        this.searchedUsersList = document.querySelector("#searchedUserList");
    ...
    fillSearchedUserToUIFromStorage() {
        ...
        if (users != null && users.length > 0) {
            users.forEach(user => {
                ...
                this.searchedUsersList.append(li);
            })
        }
    ...
    addSearchedUserToUI(username) {
        // <li class="list-group-item">batuhanatas</li>
        ...
        <div class="col-sm-12 col-md-8 col-lg-8">
          ...
          <div id="infoDiv" class="mt-3">
            ...
            <div class="info">
              ...
              <span>${user.email == null ? "" : user.company}</span>
            </div>
            <div class="info">
    ...
    clearSearchUsers() {
        this.searchedUsersList.innerHTML = "";
    }
